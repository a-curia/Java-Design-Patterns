...
public class Main {
	/*
	 * In this example we will create Soldiers and commandares into pikud merkaz ,
	 * and pikud darom. This recruit will get the soldiers as an argument. Then we
	 * will combine the pikuds by recruting both into pikud "all". This merge will
	 * get the pikud as an argument.
	 */
